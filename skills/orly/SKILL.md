---
name: orly
description: Turn a goal into requirements the codebase is evaluated against, then work until every one is satisfied; or turn a reported mistake into the requirement that catches it. Use when the user states a goal for this session, or says something the agent did was wrong.
---
